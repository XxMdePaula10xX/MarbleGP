...
export const GRIPS: Record<GripType, GripRing> = {
  Soft: {
    ...
    speedMultiplier: 1.08, gripMultiplier: 1.06,
  ...
  Medium: {
    ...
    speedMultiplier: 1.00, gripMultiplier: 1.00,
  ...
  Hard: {
    ...
    speedMultiplier: 0.96, gripMultiplier: 0.97,
  ...
  Intermediate: {
    ...
    speedMultiplier: 0.98, gripMultiplier: 1.00,
  ...
  Rain: {
    ...
    speedMultiplier: 0.95, gripMultiplier: 1.05,
